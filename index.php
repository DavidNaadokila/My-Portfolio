...
.bgimg {
  ...
  background-image: url('kitunka.jpg');
  min-height: 100%;
}
</style>
<body>
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>David Kitunka</b></h1>
    <p>Web Designer, Web Developer and Fully IT Skilled.</p>
  ...
  <div class="w3-padding-32 w3-content" id="portfolio">
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half">
        <img src="davie.jpg" style="width:100%">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-32" id="about">
    ...
    <p class="w3-wide">Fully IT Skilled</p>
    <div class="w3-light-grey">
...
<!-- 
    ...
    <img src="Avatar.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
    <p><span class="w3-large w3-text-black w3-margin-right">Reuben.</span> Web Designer.</p>
    <p>David Kitunka is just awesome. I am so happy to have met him!</p><br>
   
    <img src="Avatar.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
    <p><span class="w3-large w3-text-black w3-margin-right">Joshua.</span> CEO at Pesafy Africa.</p>
    <p>David is a sharp and objective oriented person.</p><br>
    
    <img src="Avatar.png" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:80px">
    <p><span class="w3-large w3-text-black w3-margin-right">Joshua.</span> CEO at Company.</p>
    <p>No one is better than David kitunka.</p><br>
    ...
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-half w3-margin-bottom">
        <ul class="w3-ul w3-center w3-card w3-hover-shadow">
          ...
          <li class="w3-padding-16">Fully IT Skilled</li>
          <li class="w3-padding-16">Mail Support</li>
          <li class="w3-padding-16">
            <h2>$ 25</h2>
            <span class="w3-opacity">on web development and design</span>
          </li>
      ...
      <div class="w3-half">
        <ul class="w3-ul w3-center w3-card w3-hover-shadow">
          ...
          <li class="w3-padding-16">Web Design</li>
          <li class="w3-padding-16">Web Devleloper</li>
          <li class="w3-padding-16">
            <h2>$ 25</h2>
  ...
  <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:64px">
    ...
    <div class="w3-section">
      ...
      <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone: +254720177209</p>
      <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email: davidnaadokila17@gmail.com</p>
    </div>
